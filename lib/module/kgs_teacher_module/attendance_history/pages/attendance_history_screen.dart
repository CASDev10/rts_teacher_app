...
class AttendanceHistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create:
          (context) => AttendanceHistoryCubit(sl())..fetchAttendanceHistoryList(
...
class _AttendanceHistoryScreenViewState
  ...
  Widget build(BuildContext context) {
    return BaseScaffold(
      ...
      appBar: CustomAppbar("Attendance History", centerTitle: true),
