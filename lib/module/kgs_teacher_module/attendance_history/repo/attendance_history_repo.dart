...
import 'package:rts/module/kgs_teacher_module/attendance_history/models/attendance_history_input.dart';
...
class AttendanceHistoryRepository {
  ...
  Future<AttendanceHistoryResponse> getEmployeeAttendance(
      {required AttendanceHistoryInput input}) async {
    try {
      ...
      AttendanceHistoryResponse attendanceHistoryResponse =
          await compute(attendanceHistoryResponseFromJson, response);
