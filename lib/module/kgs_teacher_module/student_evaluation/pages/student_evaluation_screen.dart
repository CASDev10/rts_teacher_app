...
import 'package:rts/module/kgs_teacher_module/student_evaluation/cubit/student_evaluation_cubit.dart';
                    ...
                    : GeneralCustomDropDown<Class>(
                        ...
                        onSelect: (value) {
                          ...
                          context
                              ...
                              .fetchSections(value.classId.toString());
                        },
                      ),
                SizedBox(
                  height: 12.0,
                    ...
                    onPressed: () async {
                      ...
                      if (state.studentList.isNotEmpty) {
                        ...
                        DisplayUtils.showToast(
                            context, "No Student Enrolled in this class");
                      }
                    },
