...
import 'package:rts/module/kgs_teacher_module/student_evaluation/models/student_evaluation_list_response.dart';
...
class StudentsEvaluationCubit extends Cubit<StudentsEvaluationState> {
  ...
  Future init(
      ...
      required List<StudentEvaluationDataModel> studentList}) async {
    emit(state.copyWith(
  ...
  Future fetchStudentsList(StudentEvaluationListInput input,
    ...
    try {
      StudentEvaluationListResponse response =
          await _repository.getStudentsEvaluationList(input: input);
  ...
  Future fetchStudentOutcomes(StudentOutcomesInput input,
      {bool showLoading = true}) async {
    if (showLoading) {
      DisplayUtils.showLoader();
    }
    ...
    try {
      StudentOutcomesListResponse response =
          await _repository.getStudentOutcomes(input: input);
  ...
  Future processResult(ProcessResultInput input) async {
    ...
    try {
      ProcessingResult processingResult =
          await _repository.processResult(input: input);
  ...
  Future unProcessResult(UnProcessResultInput input) async {
    ...
    try {
      ProcessingResult processingResult =
          await _repository.unProcessResult(input: input);
