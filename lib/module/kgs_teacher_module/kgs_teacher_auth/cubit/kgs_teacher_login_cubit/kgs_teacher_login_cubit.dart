...
class LoginCubit extends Cubit<LoginState> {
  LoginCubit(this._authenticationRepo, this._cloudMessagingApi)
      : super(LoginState.initial());
  final AuthRepository _authenticationRepo;
  final CloudMessagingApi _cloudMessagingApi;
  ...
  Future login(LoginInput loginInput, bool isKeepMeLoggedIn) async {
    ...
    try {
      ...
      loginInput.fcmToken = fcmToken;

      AuthResponse authResponse =
          await _authenticationRepo.login(loginInput, isKeepMeLoggedIn);
