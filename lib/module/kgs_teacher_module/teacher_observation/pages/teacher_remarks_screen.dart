...
import '../cubit/add_update_delete_remarks_cubit/add_update_delete_remarks_cubit.dart';
import '../cubit/fetch_observation_remarks_cubit/fetch_observation_remarks_cubit.dart';
import '../models/observation_areas_response.dart';
import '../widgets/teacher_remarks_tile.dart';
                  ...
                  children: [
                    ...
                    CustomButton(
                      onPressed: () {
                        ...
                        showAddTeacherRemarks(context, "", "", "", "", false);
                      },
                      title: 'Add Remarks',
                      height: 50,
                      width: 170,
